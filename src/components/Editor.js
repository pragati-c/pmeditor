...
import {SelectField} from "./Prompt";
    ...
    constructor(node, view, getPos) {
      ...
      divDom.querySelectorAll(".animal-item").forEach(function(itemNode, index) {
        ...
        itemNode.addEventListener("click", function() {
          console.log('itemNode', itemNode.innerHTML)
          ...
          console.log('$from.index()', text)
          // view.dispatch(view.state.tr.replaceWith(0, $to.index(), mySchema.nodes.image.create(animalData)))
  ...
  componentDidMount() {
    let view = new EditorView(this.editor, {
      ...
      dispatchTransaction(transaction) {
        //   console.log('transaction', view.state);
